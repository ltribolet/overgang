...
?>
    <div class="bg-light-grey">
        <section class="container sub_header <?php the_ID(); ?>">
            <div class="row">
                <div class="col-12">
                    <h1><?php the_title(); ?></h1>
                </div>
        ...
        <section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 about_page <?= implode( " ", get_post_class() ) ?>">
						<?php
						while ( have_posts() ) : the_post();

							$post_content = '<div class="row">' . apply_filters( 'the_content', get_the_content() ) . '</div>';
							...
							if ( $images->length > 0 ) {
								...
								$new_div->setAttribute( 'class', 'col-12 mb100' );
